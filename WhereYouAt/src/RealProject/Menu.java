...
import RealProject.SimplestPossibleExample;
import RealProject.PointMarkers.AppFrame;

public class Menu {
	static List<TraceRouteProducteur> ltrProd;
	static List<TraceRouteConsommateur> ltrCons;
	...
	public void Start() throws InterruptedException {
		...
		AppFrame a = (AppFrame) ApplicationTemplate.start(
				"NASA World Wind Tutorial - Placemarks", AppFrame.class);
		...
		while (!out) {
			...
			case "1":
				...
				System.out
						.println("Combien de threads voulez-vous executer simultanèment ?");
